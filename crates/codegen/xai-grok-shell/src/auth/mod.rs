...
/// Build/runtime status for the optional private devbox credential adapter.
pub fn devbox_login_capability_status() -> xai_grok_workspace_types::RuntimeCapabilityStatus {
    devbox_login::capability_status()
}
