...
// Legacy inline copy of the same test module from the codex branch, written
// against pre-monorepo-sync struct shapes. Kept out of compilation pending
// removal; the live version is the path-based module above.
#[cfg(any())]
mod legacy_inline_auto_compact_flow_tests {
