...
pub fn canonical_input(input: &ToolInput) -> Option<serde_json::Value> {
    ...
    Some(match input {
        ...
        | ToolInput::ReportFindings(_)
        | ToolInput::NotebookEdit(_)
        | ToolInput::CodeGraphExplore(_)
        | ToolInput::ComputerUse(_)
        ...
        | ToolInput::ScheduleWakeup(_)
        | ToolInput::UpdateGoal(_)
        | ToolInput::Workflow(_)
        | ToolInput::Sleep(_)
        | ToolInput::TurnRollback(_)
        | ToolInput::TestSync(_)
