    ...
    <div className="flex flex-col gap-4 p-4">
      ...
      {editing && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => setEditing(null)}>
          <div className="w-[420px] rounded-xl border border-gb-border bg-gb-surface p-6" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mt-4 flex justify-end gap-2">
              <button
                className="rounded-lg border border-gb-border px-3 py-1.5 text-xs text-gb-muted hover:bg-gb-bg"
