...
| `--memory`                 | Enable cross-session memory persistence (legacy alias: `--experimental-memory`) |
| `--evolution`              | Enable experience evolution in shadow mode (legacy alias: `--experimental-evolution`) |
